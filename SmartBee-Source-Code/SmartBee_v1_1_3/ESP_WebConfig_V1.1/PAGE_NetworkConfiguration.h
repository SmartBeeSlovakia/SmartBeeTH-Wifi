...
//  EN HTML PAGE
//
const char EN_PAGE_NetworkConfiguration[] PROGMEM = R"=====(
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<a href="/admin"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Network Configuration</strong>
<hr>
...
<tr><td align="center"><a href="javascript:GetState()" style="width:150px" class="btn btn--m btn--bee">Refresh</a></td></tr>
</table>
<hr>
...
//  SK HTML PAGE
//
const char SK_PAGE_NetworkConfiguration[] PROGMEM = R"=====(
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<a href="/admin"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Sieťové nastavenia</strong>
<hr>
<strong>Pripojenie na AP:</strong><br>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" style="width:310px" >
<tr><td align="right">SSID:</td><td><input type="text" id="ssid" name="ssid" value=""></td></tr>
<tr><td align="right">Heslo:</td><td><input type="text" id="password" name="password" value=""></td></tr>
<tr><td align="right">DHCP:</td><td><input type="checkbox" id="dhcp" name="dhcp"></td></tr>
<tr><td align="right">IP:     </td><td><input type="text" id="ip_0" name="ip_0" size="3">.<input type="text" id="ip_1" name="ip_1" size="3">.<input type="text" id="ip_2" name="ip_2" size="3">.<input type="text" id="ip_3" name="ip_3" value="" size="3"></td></tr>
<tr><td align="right">Maska:</td><td><input type="text" id="nm_0" name="nm_0" size="3">.<input type="text" id="nm_1" name="nm_1" size="3">.<input type="text" id="nm_2" name="nm_2" size="3">.<input type="text" id="nm_3" name="nm_3" size="3"></td></tr>
<tr><td align="right">Brána:</td><td><input type="text" id="gw_0" name="gw_0" size="3">.<input type="text" id="gw_1" name="gw_1" size="3">.<input type="text" id="gw_2" name="gw_2" size="3">.<input type="text" id="gw_3" name="gw_3" size="3"></td></tr>
<tr><td colspan="2" align="center"><input type="submit" style="width:150px" class="btn btn--m btn--bee" value="Uložiť"></td></tr>
</table>
</form>
<hr>
<strong>Stav pripojenia:</strong><div id="connectionstate">N/A</div>
<hr>
<strong>Dostupné siete:</strong><br>
<table border="0"  cellspacing="3" style="width:310px" >
<tr><td><div id="networks">Vyhľadávam...</div></td></tr>
<tr><td align="center"><a href="javascript:GetState()" style="width:150px" class="btn btn--m btn--bee">Obnoviť</a></td></tr>
</table>
<hr>
<table border="0"  cellspacing="0" cellpadding="3" style="width:350px">
<tr><td align="center"><h5><a href="http://www.smartbee.eu" >&copy;2016  SmartBee Slovakia</a></h5.<br></td></tr>
...
void send_network_configuration_html()
{
    ...
    server.send ( 200, "text/html", SK_PAGE_NetworkConfiguration  );
    }
    if (config.Language=="EN") {
    server.send ( 200, "text/html", EN_PAGE_NetworkConfiguration  );
    }
    else{
    server.send ( 200, "text/html", EN_PAGE_NetworkConfiguration  );
    }
...
void send_connection_state_values_html()
{
  ...
  if (config.Language=="SK") {
    if (WiFi.status() == 0) state = "Nečinné";
  	else if (WiFi.status() == 1) state = "ŽIADNE DOSTUPNÉ SSID";
  	else if (WiFi.status() == 2) state = "SCAN DOKONČENÝ";
  	else if (WiFi.status() == 3) state = "PRIPOJENÉ";
  	else if (WiFi.status() == 4) state = "PRIPOJENIE NEÚSPEŠNÉ";
  	else if (WiFi.status() == 5) state = "PRIPOJENIE PRERUŠENĚ";
  	else if (WiFi.status() == 6) state = "ODPOJENÉ";
  }
     ...
     if (config.Language=="SK") {
     Networks = "<font color='#FF0000'>Žiadna dostupná sieť!</font>";
	   }
   }
	else
    ...
    if (config.Language=="SK") {
      if (n==1){
        Networks = "Nájdená " +String(n) + " sieť<br>";
        }
      else {
        Networks = "Nájdené " +String(n) + " siete<br>";
      }
      if (n>=5){
        Networks = "Nájdených " +String(n) + " sietí<br>";
      }
		  Networks += "<table border='0' cellspacing='0' cellpadding='3'>";
		  Networks += "<tr bgcolor='#DDDDDD' ><td><strong>Meno</strong></td><td><strong>Kvalita</strong></td><td><strong>Kód.</strong></td><tr>";
		}
    for (int i = 0; i < n; ++i)
		{
			int quality=0;
