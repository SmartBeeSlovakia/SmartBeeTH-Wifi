...
const char LANGUAGE_main[] PROGMEM = R"=====(
  ...
  <tr><td align="center"><a href="/eng"   style="width:290px"  class="btn btn--m btn--bee" >English</a><br></td></tr>
  <tr><td align="center"><a href="/svk" style="width:290px" class="btn btn--m btn--bee" >Slovenčina</a><br></td></tr>
...
{        
    ...
    server.send ( 200, "text/html", LANGUAGE_main  );
